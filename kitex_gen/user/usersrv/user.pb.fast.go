...
func (x *EmailLoginResponse) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_EmailLoginResponse[number], err)
}

func (x *EmailLoginResponse) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.StatusCode, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}

func (x *EmailLoginResponse) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Description, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *EmailLoginResponse) fastReadField3(buf []byte, _type int8) (offset int, err error) {
...
func (x *UsernamePasswordLoginRequest) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_UsernamePasswordLoginRequest[number], err)
}

func (x *UsernamePasswordLoginRequest) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Username, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *UsernamePasswordLoginRequest) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Password, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *UsernamePasswordLoginResponse) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_UsernamePasswordLoginResponse[number], err)
}

func (x *UsernamePasswordLoginResponse) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.StatusCode, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}

func (x *UsernamePasswordLoginResponse) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Description, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *UsernamePasswordLoginResponse) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.Token, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *EmailLoginResponse) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *EmailLoginResponse) fastWriteField1(buf []byte) (offset int) {
	if x.StatusCode == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 1, x.GetStatusCode())
...
func (x *EmailLoginResponse) fastWriteField2(buf []byte) (offset int) {
	if x.Description == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 2, x.GetDescription())
...
func (x *EmailLoginResponse) fastWriteField3(buf []byte) (offset int) {
	if x.Token == "" {
		return offset
	}
...
func (x *SendEmailResponse) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 3, x.GetCredential())
	return offset
}

func (x *UsernamePasswordLoginRequest) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *UsernamePasswordLoginRequest) fastWriteField1(buf []byte) (offset int) {
	if x.Username == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetUsername())
...
func (x *UsernamePasswordLoginRequest) fastWriteField2(buf []byte) (offset int) {
	if x.Password == "" {
		return offset
	}
...
func (x *UsernamePasswordLoginResponse) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *UsernamePasswordLoginResponse) fastWriteField1(buf []byte) (offset int) {
	if x.StatusCode == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 1, x.GetStatusCode())
...
func (x *UsernamePasswordLoginResponse) fastWriteField2(buf []byte) (offset int) {
	if x.Description == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 2, x.GetDescription())
...
func (x *UsernamePasswordLoginResponse) fastWriteField3(buf []byte) (offset int) {
	if x.Token == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 3, x.GetToken())
...
func (x *EmailLoginResponse) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *EmailLoginResponse) sizeField1() (n int) {
	if x.StatusCode == 0 {
		return n
	}
	n += fastpb.SizeInt32(1, x.GetStatusCode())
...
func (x *EmailLoginResponse) sizeField2() (n int) {
	if x.Description == "" {
		return n
	}
	n += fastpb.SizeString(2, x.GetDescription())
...
func (x *EmailLoginResponse) sizeField3() (n int) {
	if x.Token == "" {
		return n
	}
...
func (x *SendEmailResponse) sizeField3() (n int) {
	...
	n += fastpb.SizeString(3, x.GetCredential())
	return n
}

func (x *UsernamePasswordLoginRequest) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *UsernamePasswordLoginRequest) sizeField1() (n int) {
	if x.Username == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetUsername())
...
func (x *UsernamePasswordLoginRequest) sizeField2() (n int) {
	if x.Password == "" {
		return n
	}
...
func (x *UsernamePasswordLoginResponse) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *UsernamePasswordLoginResponse) sizeField1() (n int) {
	if x.StatusCode == 0 {
		return n
	}
	n += fastpb.SizeInt32(1, x.GetStatusCode())
...
func (x *UsernamePasswordLoginResponse) sizeField2() (n int) {
	if x.Description == "" {
		return n
	}
	n += fastpb.SizeString(2, x.GetDescription())
...
func (x *UsernamePasswordLoginResponse) sizeField3() (n int) {
	if x.Token == "" {
		return n
	}
	n += fastpb.SizeString(3, x.GetToken())
...
var fieldIDToName_EmailLoginResponse = map[int32]string{
	1: "StatusCode",
	2: "Description",
	3: "Token",
}
...
var fieldIDToName_UsernamePasswordLoginRequest = map[int32]string{
	1: "Username",
	2: "Password",
}

var fieldIDToName_UsernamePasswordLoginResponse = map[int32]string{
	1: "StatusCode",
	2: "Description",
	3: "Token",
}
