...
var (
	...
	ErrInvalidUsername = NewErrNo(InvalidUsername, "Username start with a letter and are followed by 4 to 15 alphanumeric characters or underscores.")
	ErrInvalidPassword = NewErrNo(InvalidPassword, "Password starts with one or more letters, followed by any combination of letters, digits, and the special characters '_', '.', '+', or '*', with a total length of 8 to 20 characters.")
	ErrInvalidEmail    = NewErrNo(InvalidEmail, "The email is invalid")
)

const (
	// ErrInvalidUsername 500: invalid username
	InvalidUsername int = iota + 100401
	InvalidPassword
	InvalidEmail
)
